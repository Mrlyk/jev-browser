...
const CONFIG_DIR: &str = ".jev-browser";
const CONFIG_FILENAME: &str = "config.json";
const PROJECT_CONFIG_FILENAME: &str = "jev-browser.json";
...
mod tests {
    ...
    fn test_load_config_missing_file_returns_none() {
        let result = read_config_file(&PathBuf::from("/nonexistent/jev-browser.json"));
