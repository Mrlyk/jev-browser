...
//! Check user config files: `~/.jev-browser/config.json`,
//! `./jev-browser.json`, and any file referenced by
...
pub(super) fn check(checks: &mut Vec<Check>) {
    ...
    let user_path = dirs::home_dir().map(|d| d.join(".jev-browser").join("config.json"));
    ...
    let project_path = PathBuf::from("jev-browser.json");
